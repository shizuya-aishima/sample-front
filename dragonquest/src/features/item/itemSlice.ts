...
import { getX, getX2, getY, getY2 } from '../../utils/calculation'
...
export type ItemStateOnchange = Omit<ItemState, 'expectedValue' | 'itemList' | 'results'>
...
export const calculation = (): AppThunk => (dispatch, getState) => {
